...
protocol FDQRCodeReaderViewDelegate: AnyObject {
    func readerComplete(status: FDQRCodeReaderStatus)
}


class FDQRCodeReaderView: UIView {
    weak var delegate: FDQRCodeReaderViewDelegate?
...
extension FDQRCodeReaderView: AVCaptureMetadataOutputObjectsDelegate {
